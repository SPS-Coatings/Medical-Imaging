...
- In case of fluoroscopic angiography images also check for **vascular stenosis** — a narrowing of a coronary artery. Stenosis typically appears as a **focal or segmental narrowing** in the contrast-filled lumen of an artery. It may be identified by: 1. A **visible reduction in vessel diameter** compared to proximal or distal segments. 2. An **abrupt tapering** or “pinching” of the contrast column. 3. A segment that does **not expand uniformly** as contrast flows through. 4.Lack of expected vessel caliber during full opacification.Be careful to **exclude false positives**, such as: Natural tapering at branch points or curved segments, Motion artifacts from breathing or catheter movement, Partial filling due to early or late flow phases, 
